...
Geeometric Lib - это библиотека для вычисления площадей и периметров геометрических фигур.
...
## История создания проекта хэшами коммитов
8ba9aeb L-03: Circle and square added
d078c8d (origin/main, origin/HEAD, main) L-03: Docs added
4bb7a4f added file triangle.py
...
69f7163 (HEAD -> new_features_2_501317) Добавлены unit-тесты для всех фигур